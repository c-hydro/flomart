...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP ENVIRONMENT - PYTHON3 LIBRARIES FOR FLOMART PACKAGE - CONDA'
script_version="1.6.4"
script_date='2023/06/16'

# Define file reference path according with https link(s) --> https://repo.anaconda.com/miniconda/
# fp_env_file_miniconda='https://repo.continuum.io/miniconda/Miniconda3-py37_4.8.2-Linux-x86_64.sh' 	# python 3.7
fp_env_file_miniconda='https://repo.continuum.io/miniconda/Miniconda3-py39_23.1.0-1-Linux-x86_64.sh'	# python 3.9

# Argument(s) default definition(s)
fp_env_tag_default='flomart'

#fp_env_folder_root_default=$HOME/'fp_system_conda/'
fp_env_folder_root_default='/home/fabio/Desktop/Documents/Work_Area/Code_Development/Workspace/Flomart_Workspace/conda/'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy pandas rasterio netCDF4 cython xarray cartopy matplotlib gdal bottleneck dask pip python=3.9
