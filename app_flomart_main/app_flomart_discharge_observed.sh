...
#-----------------------------------------------------------------------------------------
# Script information
script_name='APP - RUNNER FLOMART - OBSERVED DISCHARGE - REALTIME'
...
script_file='/home/cfmi.arpal.org/idro/FloodScenario/library/fp_package_flomart_application/app_flomart_main.py'
settings_file='/home/cfmi.arpal.org/idro/FloodScenario/flomart_app_exec/app_runner_scenario_observed/app_flomart_discharge_observed_realtime.json'
