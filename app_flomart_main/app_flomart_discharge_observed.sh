...
#-----------------------------------------------------------------------------------------
# Script information
script_name='APP - RUNNER FLOOD SCENARIO - OBSERVED DISCHARGE - REALTIME'
...
settings_file='/home/cfmi.arpal.org/idro/FloodScenario/flood_app_exec/app_runner_scenario_observed/app_flood_runner_scenario_discharge_observed_realtime.json'
