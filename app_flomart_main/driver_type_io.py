...
class DriverType:
    ...
    # -------------------------------------------------------------------------------------
    # Initialize class
    def __init__(self, section_name, file_name, file_time,
    ...
    def get_data(self):
        ...
        if self.file_type == 'ascii_arpal_sim':
            ...
            log_stream.error(' ===> FileType "' + self.file_type + '" is not implemented')
            raise NotImplemented('Case will be implemented soon')
        else:
    ...
    @staticmethod
    def wrap_data_json(section_name, file_name_list,
                       file_data='simulated', file_occurrence='first', file_method_filling='ffill'):
        pass
    # -------------------------------------------------------------------------------------
