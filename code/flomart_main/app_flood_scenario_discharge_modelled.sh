...
#-----------------------------------------------------------------------------------------
# Script information
script_name='APP - RUNNER FLOOD SCENARIO - MODELLED WS DISCHARGE - REALTIME'
...
settings_file='/home/cfmi.arpal.org/idro/FloodScenario/flood_app_exec/app_runner_scenario_modelled_ws/app_flood_runner_scenario_discharge_modelled_ws_realtime.json'
